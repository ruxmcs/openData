...
def UnitTest(comp, threshold = 0.5):
     ret = ""
...
if __name__ == '__main__':
     ...
     if(os.path.isfile('./tiff_1.tif')):
         if(DEBUG): print("DEBUG file exists>", './tiff_1.tif')
     if(not os.path.isfile('./tiff_2.tif')):
         if(DEBUG): print("DEBUG file not exists>", './tiff_2.tif')
     UnitTest(comp)
     ...
     if(not os.path.isfile('./tiff_1.tif')):
         if(DEBUG): print("DEBUG file not exists>", './tiff_1.tif')
     if(os.path.isfile('./tiff_a.tif')):
         if(DEBUG): print("DEBUG file exists>", './tiff_a.tif')
     UnitTest(comp)
